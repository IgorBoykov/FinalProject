...
<body>
	...
	<div class="text-center"
		style="padding: 100px 0; width: 20%; margin: 0 auto;">
		<div class="logo">
			<spring:message code="login.login.title"></spring:message>
		</div>

		<!-- Main Form -->
		<div class="login-form-1">
			<form method="POST" action="${contentPath}/login" id="login-form"
				class="text-left form-signin">
				<div class="login-form-main-message"></div>
				<div class="main-login-form">
					<div class="login-group ${error != null ? 'has-error' : ''}">
						<span>${message}</span>
						<div class="form-group">
							<input type="text" class="form-control" id="lg_username"
								name="email"
								placeholder="<spring:message code="login.email"></spring:message>">
						</div>
						<div class="form-group">
							<input type="password" class="form-control" id="lg_password"
								name="password"
					...
					<button type="submit"
						class="btn btn-primary btn-lg btn-block pad-auth-btn">
						<spring:message code="login.signin"></spring:message>
					</button>
				</div>
				<div class="etc-login-form">
					<p>
						<spring:message code="login.newuser"></spring:message>
						<a href="${contextPath}/registration"><spring:message
								code="login.create"></spring:message></a>
					</p>
				</div>
			</form>
		</div>
