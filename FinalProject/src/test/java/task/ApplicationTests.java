...
import dao.RegisteredEntrantRepository;
...
import service.RegisteredEntrantService;
...
public class ApplicationTests {
	...
	public void testSaveFaculty() {
		...
		faculty.setSubject(Arrays.asList(Subjects.CHEMISTRY, Subjects.GEOGRAPHY, Subjects.CERTIFICATE_MARK));
	...
	public void testFindFacultyById() {
		...
		faculty.setSubject(Arrays.asList(Subjects.HISTORY, Subjects.COMPUTER_SCIENCE, Subjects.MATHEMATICS));
	...
	public void testFindAllFaculties() {
		...
		faculty2.setSubject(Arrays.asList(Subjects.PHISICS, Subjects.SPORTS, Subjects.UKRAINE));
	...
	public void testSaveRegisteredEntrant() {
		...
		faculty.setName("Faculty1");
		faculty.setStudents(40);
		faculty.setSubject(Arrays.asList(Subjects.SPORTS, Subjects.COMPUTER_SCIENCE, Subjects.MATHEMATICS));
	...
	public void testFindAllRegisteredEntrants() {
		...
		faculty1.setSubject(Arrays.asList(Subjects.GEOGRAPHY, Subjects.CHEMISTRY, Subjects.CERTIFICATE_MARK));

		Faculty faculty2 = new Faculty();
		faculty2.setName("Faculty2");
		faculty2.setStudents(38);
		faculty2.setSubject(Arrays.asList(Subjects.ENGLISH, Subjects.MATHEMATICS, Subjects.COMPUTER_SCIENCE));
